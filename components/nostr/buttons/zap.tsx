  ...
  return (
    <>
      <button
        ...
        className={cn(
          "flex items-center gap-2 text-sm text-amber-500 dark:text-amber-400 hover:text-amber-600 dark:hover:text-amber-300 transition-colors",
          className,
        )}
      >
        <Zap className="h-5 w-5" />
        {showAmount && totalAmount > 0 && <span>{totalAmount}</span>}
      </button>
